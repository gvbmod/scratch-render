...
const BubbleStyle = {
    MAX_LINE_WIDTH: 200, // Maximum width, in Scratch pixels, of a single line of text

    MIN_WIDTH: 60, // Minimum width, in Scratch pixels, of a text bubble
    STROKE_WIDTH: 4, // Thickness of the stroke around the bubble. Only half's visible because it's drawn under the fill
    PADDING: 4, // Padding around the text area
    ...
    FONT: 'arial', // Font to render the text with
    ...
    LINE_HEIGHT: 15, // Spacing between each line of text

    COLORS: {
        BUBBLE_FILL: 'white',
        BUBBLE_STROKE: '#bdbdbd',
        TEXT_FILL: '#575E75'
    }
};
